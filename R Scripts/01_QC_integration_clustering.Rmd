...
```{r, results = FALSE, message=FALSE, warning=FALSE}
sampleNames <- c("IBDUC035","IBDUC111","IBDUC115","IBDUC116","IBDUC121","IBDUC125","IBDUC129","IBDUC135","IBDUC146","IBDUC151","IBDUC154","IBDUC167","IBDUC173","IBDUC245","IBDUC303","NV138","NV140","NV144","NV157","NV159","NV161","NV162")
data_dir <- (".../IEL")
projectName <- "IEL"
h5_string <- ".h5"
```
...
# Filter out cells with >20% mitochondrial gene exp and nFeature > 200 and save
```{r, results = FALSE, message=FALSE, warning=FALSE}
